...
export function CategoryChip({ label, active, onSelect, disabled = false }: CategoryChipProps) {
  return (
    <button
      type="button"
      onClick={onSelect}
      ...
      className={[
        ...
        "focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-maroon disabled:opacity-50",
        active
